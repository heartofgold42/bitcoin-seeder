...
static const string mainnet_seeds[] = {"209.250.230.23", "144.202.4.242", "45.77.228.56", "45.77.228.215", "108.61.103.35", "199.247.28.248", ""};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("nkqe6ehbv4yvrh2u.onion", 52543), true);
  }
  do {
